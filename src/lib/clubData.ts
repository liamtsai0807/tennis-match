 ...
 * 另加 2 個開放資料漏掉但確實訂得到的（見 clubOverrides.ts）。
 */
...
export const REAL_CLUBS: Club[] = [
  ...
  },
  {
    ...
    lights: true,
    price_per_hour: 140,
    price_note: "每小時 140 元，日間夜間同價。臺北市體育局線上預約，要先註冊會員。未開放線上預約的面只供現場民眾輪流使用，不能營利。",
    rating: null,
    courts: 2,
    open_hour: 8,
    close_hour: 22,
